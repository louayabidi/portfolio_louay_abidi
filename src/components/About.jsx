...
export default SectionWrapper(About, "about"); //3ayet l SectionWrapper bech yhot les cadres fel wost w about loula ta3 compnant w thenia lel id (const StarWrapper = (Component, idName) mawjouda f SectionWrapper.jsx)